          ...
          <ul class="navbar-nav ml-auto">
            <li class="nav-item">
              <form action="{{ route('logout') }}" method="POST">
                @csrf
                <button type ="submit" class="btn btn-danger"><i class="fas fa-sign-out-alt"></i> Cerrar sesi&oacute;n</button>
              </a>
            </form>
            </li>
          </ul>
      ...
      <div class="mt-3 pb-3 mb-3">
        <div class="text-center">
            <div >
             ...
             <a class="lin">{{Auth()->user()->titulo . ' ' . Auth()->user()->nombre . ' '  .Auth()->user()->app . ' ' . Auth()->user()->apm}}</a>
             <br>
            @if (Auth()->user()->idtu_tipos_usuarios == 1) 
                <a class="lin">Administrador</a>
              @endif
              @if (Auth()->user()->idtu_tipos_usuarios == 2) 
                <a class="lin">Direccion de Carrera</a>
              @endif
              @if (Auth()->user()->idtu_tipos_usuarios == 3) 
                <a class="lin">Rector</a>
              @endif
              @if (Auth()->user()->idtu_tipos_usuarios == 4) 
                <a class="lin">Secretaria</a>
              @endif
              <br><br>
