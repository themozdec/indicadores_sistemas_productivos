...
@section('content')
    ...
    <div class="container-fluid">
        <!--div class="card bg-light">
            ...
            <b>Nota:</b> Recuerda que es muy importante ingresar todos los datos para poder realizar la consulta.
            </div>
                <div class="form-row mt-3" id="dashboard_panel">
                    <div class="form-group col-md-4">
                        <label>Tipo de área: <strong style="color: red;">*</strong></label>
                    ...
                    <div class="form-group col-md-4">
                        <label>Fecha inicial: <strong style="color: red;">*</strong></label>
                        <input type="date" class="form-control" name="inicio" id="fecha_inicial">
                    </div>
                    <div class="form-group col-md-4">
                        <label>Fecha final: <strong style="color: red;">*</strong></label>
