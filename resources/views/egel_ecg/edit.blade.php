...
<style type="text/css">
    ...
    <div class="card">
            ...
            <div class="card-body">
                @foreach($alumno as $a)
                    <form id="formulario-actualizar-egel_ecg" action="{{ route('egel_ecg.update', $a->ide) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PATCH')
                                @if ($errors->any())
            ...
            <div class="form-group col-xs-3 col-md-6">
                    ...
                    <input type="number" class="form-control" id="promedio_ing" name="promedio_ing" value="{{ $a->promedio_ing }}" step="0.01" min="8" max="10" placeholder="Ingresa un promedio" required>
                                ...
                                <div class="form-group text-center">
                                    ...
                                    <a title="Guardar" href="{{ route('egel_ecg.index') }}" class="btn btn-danger"><i class="fas fa-ban"></i></a>
                                </div>
                    </form>
                 @endforeach
